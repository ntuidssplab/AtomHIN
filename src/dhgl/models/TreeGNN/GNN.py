...
class GAT(nn.Module):
    ...
    def __init__(
        ...
        self.gat_layers.append(
            GATConv(
                num_hidden, num_hidden, heads[0], feat_drop, attn_drop,
        ...
        for l in range(1, num_layers):
            self.gat_layers.append(
                GATConv(
                    num_hidden * heads[l - 1], num_hidden, heads[l], feat_drop,
        ...
        self.gat_layers.append(
            GATConv(
                num_hidden * heads[-2], num_classes, heads[-1], feat_drop,
...
class GCN(nn.Module):
    ...
    def __init__(
        ...
        self.layers.append(
            GraphConv(
                num_hidden, num_hidden, activation=activation, weight=False
            )
        )
        # Hidden Layers
